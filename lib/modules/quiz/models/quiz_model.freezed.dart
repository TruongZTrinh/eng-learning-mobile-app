...
abstract class $QuizModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, String description, QuizType type});
}
...
class _$QuizModelImpl implements _QuizModel {
  ...
  @override
  String toString() {
    return 'QuizModel(title: $title, description: $description, type: $type)';
  }
...
abstract class _QuizModel implements QuizModel {
  const factory _QuizModel(
      ...
      required final QuizType type}) = _$QuizModelImpl;
